-- =============================================================================
-- SIGDoc — RESET COMPLETO (apaga tudo e recria)
-- Base: defaultdb (Aiven) ou outra BD já seleccionada no DBeaver
--
-- No DBeaver: abre este ficheiro → selecciona a BD defaultdb → Execute SQL Script
-- (Alt+X) — NÃO uses Ctrl+Enter só numa linha
--
-- Login seed depois do script:
--   admin@sigdoc.local  /  Admin@123
--   gestor@sigdoc.local /  Admin@123
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- 1) Apagar tabelas existentes (ordem irrelevante com FK checks off)
-- -----------------------------------------------------------------------------
...
CREATE TABLE `acessos_geograficos` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `usuario_id` INT UNSIGNED NOT NULL,
  `documento_id` INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE `limites_geograficos` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(120) NOT NULL,
